 ...
 * @param {*} param0
 */
function PanelStudyBrowserBottom({
  servicesManager,
  getImageSrc,
  ...
  useEffect(() => {
    ...
    async function fetchStudiesForPatient(StudyInstanceUID) {
      ...
      // server can respond.
      try {
        qidoStudiesForPatient = await getStudiesForPatientByMRN(dataSource, qidoForStudyUID, 'PanelStudyBrowserBottom');
  ...
  function _createDisplaySetForStudy(StudyInstanceUID) {
    const madeInClient = true;
    requestDisplaySetCreationForStudy(displaySetService, StudyInstanceUID, madeInClient);
  }
  ...
  return (
    <StudyBrowserBottom
      ...
      createDisplaySetForStudy={_createDisplaySetForStudy}
      setExpandedStudyInstanceUIDs={setExpandedStudyInstanceUIDs}
    />
  );
}

PanelStudyBrowserBottom.propTypes = {
...
export default PanelStudyBrowserBottom;
