...
import { WrappedPanelStudyBrowserBottom } from '../../../../../extensions/default/src/Panels';
    ...
    >
      {panelOpen ? (
        <>
          ...
          {/* {tabs.map((tab, tabIndex) => {
            console.log("bottompanel tab loop", tab.content, tabIndex, activeTabIndex);
          ...
          // }}
          /> */}
          <WrappedPanelStudyBrowserBottom servicesManager={servicesManager} {...props} />
        </>
      ) : (
